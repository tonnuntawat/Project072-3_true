...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("sdsBis"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class sdsBis
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As sdsBis = CType(MyBase.Clone,sdsBis)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "sdsBis"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/sdsBis.xsd"
    ...
    Partial Public Class EmployeesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddEmployeesRow(ByVal LastName As String, ByVal FirstName As String, ByVal BirthDate As Date, ByVal HireDate As Date) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, LastName, FirstName, BirthDate, HireDate}
...
Namespace sdsBisTableAdapters
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastNa"& _ 
                ...
                "ND ((@IsNull_HireDate = 1 AND [HireDate] IS NULL) OR ([HireDate] = @Original_Hir"& _ 
                "eDate)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Employees] ([LastName], [FirstName], [BirthDate], [HireDate]) VALUES"& _ 
                " (@LastName, @FirstName, @BirthDate, @HireDate);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, LastName, F"& _ 
                "irstName, BirthDate, HireDate FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY("& _ 
                "))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [BirthDa"& _ 
                "te] = @BirthDate, [HireDate] = @HireDate WHERE (([EmployeeID] = @Original_Employ"& _ 
                "eeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstNa"& _ 
                "me) AND ((@IsNull_BirthDate = 1 AND [BirthDate] IS NULL) OR ([BirthDate] = @Orig"& _ 
                "inal_BirthDate)) AND ((@IsNull_HireDate = 1 AND [HireDate] IS NULL) OR ([HireDat"& _ 
                "e] = @Original_HireDate)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, LastName, FirstName, BirthDate, "& _ 
                "HireDate FROM Employees WHERE (EmployeeID = @EmployeeID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Myproject_072_3_VB.My.MySettings.Default.strCon
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        EmployeeID, LastName, FirstName, BirthDate, HireDate"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         "& _ 
                "   Employees"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As sdsBis.EmployeesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As sdsBis.EmployeesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As sdsBis.EmployeesDataTable = New sdsBis.EmployeesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As sdsBis.EmployeesDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As sdsBis) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmployeeID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_BirthDate As Global.System.Nullable(Of Date), ByVal Original_HireDate As Global.System.Nullable(Of Date)) As Integer
            ...
            If (Original_HireDate.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_HireDate.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal LastName As String, ByVal FirstName As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal HireDate As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal LastName As String, ByVal FirstName As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal HireDate As Global.System.Nullable(Of Date), ByVal Original_EmployeeID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_BirthDate As Global.System.Nullable(Of Date), ByVal Original_HireDate As Global.System.Nullable(Of Date), ByVal EmployeeID As Integer) As Integer
            If (LastName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("LastName")
            Else
        ...
        Public Overloads Overridable Function Update(ByVal LastName As String, ByVal FirstName As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal HireDate As Global.System.Nullable(Of Date), ByVal Original_EmployeeID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_BirthDate As Global.System.Nullable(Of Date), ByVal Original_HireDate As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(LastName, FirstName, BirthDate, HireDate, Original_EmployeeID, Original_LastName, Original_FirstName, Original_BirthDate, Original_HireDate, Original_EmployeeID)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As sdsBis, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As sdsBis, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._employeesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As sdsBis, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._employeesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As sdsBis) As Integer
